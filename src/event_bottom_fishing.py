...
# ============================================================================
# LEGACY agent-review implementation (selectable via --agent-impl legacy).
#
# This is a second, self-contained agent committee. By default the live run
# uses agent_runtime.run_agent_reviews (--agent-impl runtime); pass
# --agent-impl legacy (or AGENT_IMPL=legacy) to route apply_agent_reviews
# through `apply_agent_reviews_legacy` below instead.
#
# Differences vs the runtime impl: this one uses a richer 6-factor
# `evidence_quality` model and an optional final OpenAI overlay, but does not
# emit a per-task tool/plan trace. It relies on fundamentals + data_confidence
# already being attached to each candidate (it does not fetch SEC data itself).
# See REFACTOR_PLAN.md Step 3.
# ============================================================================
